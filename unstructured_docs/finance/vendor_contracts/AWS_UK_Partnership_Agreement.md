...
- Specialisations: Contact Centre, Communications
- Competencies: Amazon Connect Delivery
- Benefits: Technical support, funding, co-sell
...
|--------|--------|---------|
| Platform Availability | 99.99% | Credit |
| Mean Time to Resolve | 4 hours | Credit |
| Change Success Rate | 98% | Review |
| Customer Satisfaction | NPS >50 | Review |
...
| Certification | Holders | Target |
|---------------|---------|--------|
| AWS Solutions Architect | 8 | 15 |
| Amazon Connect Specialist | 5 | 10 |
| AWS DevOps Engineer | 4 | 8 |
| AWS Security | 3 | 6 |
...
| Business Development | BDM | Sales Director |
| Marketing | Partner Marketing | CMO |
...
| Technical sync | Monthly | Architecture |
| Pipeline review | Bi-weekly | Opportunities |
| Marketing sync | Monthly | Campaigns |
...
|----------|---------|----------|
| Contract end | Data export | 90 days |
| Migration | Assisted | 180 days |
| Termination | Wind-down | 12 months |
