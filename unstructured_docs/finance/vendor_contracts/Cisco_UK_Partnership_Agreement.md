...
**Cisco Gold Partner**
- Specialisations: Collaboration, Enterprise Networking
- Benefits: Deal registration, MDF, training credits
...
| Level | Response Time | Resolution |
|-------|---------------|------------|
| P1 - Critical | 15 minutes | 4 hours |
| P2 - Major | 1 hour | 8 hours |
...
|---------------|-------------|----------|
| Webex Sales | 10 staff | 2 years |
| Webex Technical | 5 engineers | 2 years |
| Contact Centre | 3 specialists | 2 years |
| Network | 5 engineers | 2 years |
...
|--------|-----------|-------|
| Executive | Quarterly | Strategy, investment |
| Business | Monthly | Pipeline, forecast |
| Technical | Bi-weekly | Issues, roadmap |
| Marketing | Monthly | Campaigns, MDF |
...
| Marketing | Channel Marketing | Marketing Director |
| Operations | Partner Ops | Ops Director |
...
- Initial term: 5 years (to April 2027)
- Auto-renewal: 12-month periods
- Notice period: 12 months for termination

### Exit Provisions

| Scenario | Process |
|----------|---------|
| End of term | 12-month wind-down |
| Breach | 90-day cure period |
| Change of control | 6-month review |
