...
| Cost management | Within 5% of budget | 3.2% under |
| Quality scores | 4.0+ out of 5.0 | 4.4 |
| Response time | 95% within agreed timeframes | 97% |
| Security audit pass rate | 100% | 100% |

## Contract Review Schedule

| Vendor | Contract Renewal | Review Owner |
|--------|-----------------|--------------|
...
- No single vendor >25% of technology spend
- Alternative suppliers identified for critical services
- Business continuity plans for top 5 vendors
...
**Policy Owner**: Commercial Director  
