...
**Eutelsat Communications - Revenue Per Seat Analysis**

## Executive Summary

This analysis examines Average Revenue Per User (ARPU) trends across Eutelsat's cloud communications portfolio. With **1.8 million Cloud seats** (up 50% YoY), Eutelsat maintains strong unit economics despite some customers opting for lower-cost solutions in the challenging macro-economic environment. The Group added **587,000 seats** since June 2024, with Germany contributing significantly following the Starface and Placetel acquisitions.

---

## Overall ARPU Performance

### Cloud Seats Summary (H1 2025)

| Region | Cloud PBX Seats | H1 Change | YoY Change |
|--------|-----------------|-----------|------------|
| UK | 1,063K | +2% | +6% |
...
| Contact Centre (CCaaS) | £88.00 | £82.00 | +7.3% | ↑ |
...
| UK Cloud Seats | 1,063K | 1,002K | +6% |

**ARPU Drivers:**
- PhoneLine+ growth at lower ARPU (45K seats, +32% in half)
- SIP Cloud solutions growing but at lower price points
...
**ARPU Drivers:**
- BrightCloud acquisition (Cisco UCaaS) bringing higher ARPU customers
...
| Cloud Seats | 565K | 38K | +1,387% |

**ARPU Drivers:**
- Starface premium enterprise-focused positioning
- Placetel self-serve SMB platform with high efficiency
- No significant mobile/licensing costs improving margin
- Organic seat additions: 29,000 in H1 (proforma)
...
| Segment | Est. ARPU/Seat | Seats | Monthly GP | % Mix |
|---------|----------------|-------|------------|-------|
| Enterprise (250+) | £24.50 | 180K | £4.4M | 27% |
| Mid-Market (50-249) | £15.20 | 320K | £4.9M | 30% |
| SMB (1-49) | £8.80 | 450K | £4.0M | 24% |
| Public Sector | £18.80 | 85K | £1.6M | 10% |
| Partner (internal) | £5.20 | 28K | £0.15M | 1% |
| PhoneLine+/Micro | £5.80 | 45K | £0.26M | 2% |
| **Blended UK** | **£13.80** | **1,108K** | **£15.3M** | **100%** |
...
| SIP - Non-Eutelsat Cloud (UK) | 498K | £4.20 | £2.1M |
...
| Region | Seats | ARPU/Seat | Monthly Rev |
|--------|-------|-----------|-------------|
| UK | 48K | £88.00 | £4.2M |
| Europe | 5K | €72.00 | €0.36M |
| **Total CCaaS** | **53K** | **£85.00** | **~£4.5M** |

---

## ARPU Trend Analysis

### ARPU Drivers - Positive

| Driver | Impact | Products |
|--------|--------|----------|
| Cisco Collaboration Suite launch | +£0.40 | UCaaS + CCaaS |
| AI Receptionist (Q4 2025) | +£0.35 | Horizon, Starface |
| Microsoft Teams growth | +12% users | Operator Connect |
| Contact Centre expansion | +7% seats | Horizon Contact |
...
|--------|--------|------------|
| Macro-economic SME caution | -£0.50 | PhoneLine+ alternatives |
| Copper-to-fibre migration | -£0.30 | Fibre comparison site |
| Ethernet price war | -£0.40 | Value-based selling |
| Lower-cost product preference | -£0.35 | Upgrade paths |
...
| Provider | Est. ARPU | vs Eutelsat | Notes |
|----------|-----------|----------|-------|
...
| **Eutelsat (blended)** | **£13.80** | **-** | **Channel efficiency** |
...
| **Eutelsat Germany (blended)** | **€10.90** | **-** | **Multi-brand strategy** |

---

## ARPU Improvement Initiatives FY 2025

### Product-Led Initiatives

| Initiative | Target ARPU Impact | Launch Date |
|------------|-------------------|-------------|
| AI Receptionist (UK/DE) | +£0.40/seat | Q4 2025 |
...
| Fusion IoT eSIM (UK/DE) | +£0.30/seat | H2 2025 |

### Segment-Led Initiatives

| Initiative | Target Segment | ARPU Impact |
|------------|----------------|-------------|
| Contact Centre upsell | Mid-Market | +£5.00 |
| Managed Cyber services | Enterprise | +£3.50 |
| SD-WAN bundling | Enterprise | +£2.80 |
| WhatsApp integration | SMB | +£0.80 |
...
- PhoneLine+ benefiting from "spend less" trend (+32% seats in half)
...
- Now represents **20% of Group gross profit**

---

**Prepared by**: Commercial Finance  
**Date**: September 2025  
**Source**: Eutelsat Communications H1 2025 Interim Results  
