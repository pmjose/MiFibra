...
| Attach Rate | 85%+ | 75%+ | 65%+ | 50%+ |

### Top Partner Characteristics

| Factor | Top Quartile | Median | Bottom Quartile |
|--------|--------------|--------|-----------------|
| Certified staff | 5+ | 2 | 0 |
| Demo capability | Full lab | Basic | None |
| Marketing activity | Active MDF | Occasional | None |
| Support capability | Tier 1 | Basic | Escalate all |
| Specialisations | 3+ | 1 | 0 |

---

## Partner Success Framework

### 5 Pillars of Partner Excellence
...
| Element | Best Practice | Impact |
|---------|---------------|--------|
| Account management | Proactive reviews | -40% churn |
| Training delivery | Customer enablement | +15 NPS points |
| Support capability | First-line resolution | +25 NPS points |
| Business reviews | Quarterly minimum | +20% expansion |
...
| Element | Best Practice | Impact |
|---------|---------------|--------|
| Portal utilisation | Self-serve ordering | -50% order time |
| API integration | Automated provisioning | -70% effort |
| Billing management | Real-time tracking | -80% queries |
| Reporting | Dashboards active | +25% insight |

---

## Partner Development Paths

### From Registered to Silver
...
| Cause | Solution |
|-------|----------|
| Weak discovery | SPIN training programme |
| Poor demo skills | Demo certification |
| Competitive losses | Battle card training |
| Pricing issues | Deal desk support |

### High Churn Rate (>1.5%)

| Cause | Solution |
|-------|----------|
| Poor onboarding | Implementation best practices |
| Support issues | Support escalation path |
| Feature gaps | Product feedback loop |
| Competitor activity | Retention playbook |

### Low Expansion Rate (<5%)

| Cause | Solution |
|-------|----------|
| No account reviews | QBR template |
| Limited awareness | Cross-sell training |
| Customer engagement | Success metrics dashboard |
| Missed triggers | Expansion playbook |
...
|----------|--------|---------|
| Revenue | 30% | ARR, growth, mix |
| Customer | 25% | NPS, churn, expansion |
| Capability | 20% | Certifications, demo |
| Engagement | 15% | Portal, training, events |
| Pipeline | 10% | Opportunities, conversion |

### Health Indicators

| Score | Status | Action |
|-------|--------|--------|
| 80-100 | Excellent | Recognition, investment |
| 60-79 | Good | Growth support |
| 40-59 | At Risk | Improvement plan |
...
| Resource | Access | Purpose |
|----------|--------|---------|
| Campaign kits | Portal | Ready-to-use campaigns |
| Content library | Portal | Collateral, emails |
| Brand assets | Portal | Logos, templates |
| MDF application | Portal | Funding requests |

### Sales Resources

| Resource | Access | Purpose |
|----------|--------|---------|
| Battle cards | Portal | Competitive positioning |
| ROI calculator | Portal | Business case tools |
| Case studies | Portal | Customer evidence |
| Proposal templates | Portal | Professional proposals |
