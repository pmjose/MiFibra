...
| **Solution** | Design solution | Technical pre-sales |
| **Propose** | Present to customer | Pricing support |
| **Negotiate** | Close deal | Deal desk approval |
| **Onboard** | Project manage | Implementation support |
| **Adopt** | Drive usage | Training resources |

### Deal Registration Benefits

| Registration Stage | Benefit |
|--------------------|---------|
| Early registration | +3% margin protection |
| Valid for | 90 days |
| Extension | 30 days on request |
| Competitive displacement | +5% additional |
...
**Talking Points:**
- "Keep your numbers, add enterprise calling"
- "One platform for everything - simplify IT"
- "Carrier-grade quality, not OTT"

### Contact Centre Modernisation

**Opportunity**: Legacy call centres moving to cloud
...
| Flexibility | Rigid | Flexible | "We build solutions together" |
...
| Features | Basic | Advanced | "Enterprise features included" |
| Billing | Per user | Flexible | "Pay for what you need" |

---

## Deal Desk Guidelines

### Pricing Authority

| Deal Size | Approval Level | Turnaround |
|-----------|----------------|------------|
| Standard pricing | Partner | Immediate |
| <10% discount | CAM | 4 hours |
| 10-20% discount | Sales Manager | 24 hours |
| >20% discount | Commercial Director | 48 hours |
| Strategic deal | CCO | 72 hours |

### Discount Justification

| Reason | Max Additional |
|--------|----------------|
...
| Tool | Purpose | Access |
|------|---------|--------|
| Partner Portal | Orders, quotes, support | All partners |
| Quote Builder | Solution pricing | All partners |
| Customer Dashboard | Usage, billing | Gold+ |
| API Access | Automation | Gold+ |
| Demo Environment | Customer demos | Silver+ |
...
| Element | Content |
|---------|---------|
| Sales performance | vs target, pipeline |
| Product mix | Category analysis |
| Customer health | NPS, churn risk |
| Enablement | Training, support |
| Opportunities | Upsell, expansion |

### Quarterly Partner Reviews

| Topic | Focus |
|-------|-------|
| Business review | Revenue, growth |
| Joint planning | Targets, campaigns |
| Roadmap preview | New products |
