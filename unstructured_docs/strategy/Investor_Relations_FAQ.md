...
### Q: Who are Eutelsat's competitors?
...
- **Voice/SIP**: BT, TalkTalk Business, regional telcos
- **Connectivity**: BT Openreach (wholesale), CityFibre, Virgin Media Business

---

## Financial Performance

### Q: What are Eutelsat's key financial metrics?
...
### Q: How does Eutelsat generate revenue?
...
### Q: What is Eutelsat's revenue mix by product?
...
- Contact Centre: 8%
- Other (Security, Managed Services): 4%

### Q: What drives revenue growth?

**A:** Key growth drivers:
1. **PSTN Switch-Off**: 5.5M UK business lines migrating to cloud by 2027
2. **Microsoft Teams Phone**: Fastest-growing product, 80K+ seats
...
### Q: What is Eutelsat's dividend policy?

**A:** Eutelsat operates a progressive dividend policy targeting approximately 30% of adjusted earnings. The current annual dividend is approximately 18p per share, paid in two instalments (interim in September, final in May).

### Q: Does Eutelsat conduct share buybacks?

**A:** Eutelsat may conduct share buybacks opportunistically to manage dilution from employee share schemes. We maintain authorisation for buybacks but prioritise organic investment and strategic acquisitions.

### Q: What is the target capital structure?

**A:** We target net debt of 0.5-1.5x EBITDA to maintain investment grade credit metrics while preserving capacity for acquisitions. Current leverage is approximately 0.4x EBITDA.

---

## Growth Strategy

### Q: What is Eutelsat's growth strategy?
...
### Q: Where are Eutelsat shares traded?

**A:** Eutelsat Communications PLC shares are traded on the AIM market of the London Stock Exchange under ticker "GAMA". We announced plans to move to the Main Market of the London Stock Exchange in May 2025.

### Q: Why is Eutelsat moving to the Main Market?

**A:** The Main Market listing will:
- Increase visibility with institutional investors
- Enable index inclusion (FTSE 250 eligibility)
- Enhance governance and transparency
- Reflect our growth and scale
- Improve liquidity
...
- Retail investors: ~20%
(Based on most recent disclosures - please verify with RNS announcements)

---

## ESG and Sustainability

### Q: What are Eutelsat's ESG commitments?

**A:** Key ESG commitments:
- **Environment**: Net Zero by 2040, 80% renewable energy by 2025
- **Social**: 40% female leadership target, apprenticeship programme
- **Governance**: Independent board majority, diversity targets
- Carbon footprint reduction through cloud migration for customers

### Q: Does Eutelsat have sustainability certifications?
...
### Q: What is Eutelsat's acquisition strategy?

**A:** We pursue selective acquisitions that provide:
- **Technology**: Accelerate product roadmap
- **Market Access**: Geographic expansion in Europe
- **Scale**: Partner bases or customer portfolios
- Typical deal size: £5-50 million, funded from cash/debt

### Q: Recent acquisition history?

**A:** Recent acquisitions include:
- HFO Telecom (Germany) - 2023
- Eutelsat Spain (rebranding) - 2022
...
### Q: What guidance has Eutelsat provided for 2025?

**A:** FY2025 guidance:
- Revenue growth: 8-10%
- EBITDA margin: 21-23%
- CapEx: £35-40 million (7-8% of revenue)
- Partner additions: 100+ net new
- UCaaS seat growth: 20-25%

### Q: What are the key risks to guidance?

**A:** Key risks include:
- Economic downturn reducing business IT spending
- Microsoft native voice expansion
- Competitive pricing pressure
- PSTN switch-off delays
- Execution risk on European expansion

---

## Analyst Coverage

### Q: Who covers Eutelsat?

**A:** Eutelsat is covered by:
- Berenberg
- Jefferies
- Peel Hunt
- Shore Capital
...
**Document Status**: Approved for External Use  
