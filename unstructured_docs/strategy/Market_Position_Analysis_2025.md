...
**Strategic Planning Document - Eutelsat Communications PLC**

## Executive Summary

This analysis provides a comprehensive view of Eutelsat's competitive position in the European business communications market as we enter the second half of 2025. Following the strategic acquisitions of Starface and Placetel in Germany, Eutelsat has achieved significant scale with **£316.6 million H1 2025 revenue** (+12% YoY), **1.8 million Cloud seats** (+50% YoY), and successful transition to the **Main Market of the London Stock Exchange with FTSE 250 inclusion** in June 2025.

Eutelsat is uniquely positioned as a pan-European channel-first communications provider with market-leading positions in both the UK (1,500+ partners) and Germany (rapidly growing following strategic acquisitions).
...
| Metric | 2024 Value | 2025 Forecast | Eutelsat Position |
|--------|------------|---------------|----------------|
...
|----------|--------------|----------------|----------|----------|
| **Eutelsat** | Channel-first B2B | £186M (H1 Business) | #1 partner network, UK-centric | Direct enterprise scale |
...
| **BT Business** | Large Enterprise | £2.1B | Scale, network | Agility, cost structure |

### Germany Market Competitors

| Provider | Market Focus | Revenue (Est.) | Strength | Weakness |
|----------|--------------|----------------|----------|----------|
| **Eutelsat (Starface/Placetel)** | Channel + Digital | €49M+ (H1) | Premium + self-serve | Integration phase |
...
| **Cisco Webex** | Enterprise Direct | €150M | Brand, global | Channel limited |
...
- UK market share declining (~9%)
- Strong XCaaS (combined UCaaS+CCaaS) proposition

**Strengths:**
- Integrated UCaaS and CCaaS platform
- Global voice network
- Good channel programme (Partner Connect)

**Weaknesses:**
- Complex pricing confuses partners
- Support inconsistencies
- Uncertain long-term strategy

**Eutelsat Opportunity:** Partner recruitment from 8x8 channel

### RingCentral UK

**Current Status (2025):**
- Enterprise focus intensifying
- Teams integration (RingCentral for Teams) gaining traction
- Limited UK channel expansion

**Strengths:**
- Strong brand recognition
- Microsoft Teams integration
- Large enterprise references

**Weaknesses:**
- Direct sales creates channel conflict
- Premium pricing limits SMB
- US-centric roadmap

**Eutelsat Opportunity:** SMB/Mid-Market partners seeking alternatives

### Mitel UK

**Current Status (2025):**
- On-premise to cloud transition ongoing
- Market share declining (now ~5%)
- Merger/acquisition speculation continues

**Strengths:**
- Large installed base
- Partner relationships (legacy)
- Contact centre portfolio

**Weaknesses:**
- Cloud transition struggles
- Financial stability concerns
- Technology debt

**Eutelsat Opportunity:** Migration of Mitel partner base

### Microsoft Teams

**Current Status (2025):**
- Fastest growing UCaaS platform (38% share)
...
**Eutelsat Strategy:** Voice enablement partner, not competitor

---

## Eutelsat Competitive Position

### SWOT Analysis (Updated September 2025)

**Strengths:**
- **#1 UK channel partner network** with 1,500+ active partners
- **FTSE 250 listed** (Main Market, June 2025)
- **1.8 million Cloud seats** (+50% YoY)
- **90% recurring revenue** providing stability
- **German market now at scale** (565K seats, 20% of Group GP)
- Strong Microsoft partnership (Operator Connect, Cisco)
- UK-built, UK-supported solutions

**Weaknesses:**
- UK macro-economic pressures affecting SME spending
- Enterprise direct sales still developing
- Germany integration complexity (Starface + Placetel)
- Brand awareness lower than global players outside UK

**Opportunities:**
- **Germany cloud market underpenetration** (largest EU market, lowest cloud adoption)
- PSTN switch-off driving UK cloud migration (2027)
- Microsoft Teams Phone/Operator Connect growth
- AI features differentiation (AI Receptionist Q4 2025)
- Competitor instability (8x8, Mitel)
- Pan-European Cisco Collaboration Suite opportunity

**Threats:**
- UK macro-economic conditions affecting SME confidence
...
### Germany UCaaS Market Share (Seats, Estimated)
...
| NFON | 12% | 11% | 10% | ↓ |
| Sipgate | 8% | 8% | 7% | → |
| **Eutelsat (Starface/Placetel)** | 2% | **5%** | 7% | ↑↑↑ |
| Cisco (direct) | 5% | 5% | 5% | → |
| Others | 45% | 45% | 46% | → |

---

## Eutelsat H1 2025 Performance Highlights
...
| Adjusted EPS | 47.9p | 42.5p | +13% |

### Business Unit Performance

| Business Unit | Gross Profit H1 2025 | H1 2024 | YoY |
|---------------|----------------------|---------|-----|
| Eutelsat Business (UK SME) | £97.4M | £97.1M | +0% |
| Eutelsat Enterprise | £30.9M | £28.9M | +7% |
| Germany | £34.4M | £9.8M | +251% |
| Other Europe | £9.3M | £9.9M | -6% |

### Cloud Seats (thousands)

| Region | Jun 2025 | Jun 2024 | YoY |
|--------|----------|----------|-----|
| UK Cloud PBX | 1,063 | 1,002 | +6% |
| Germany Cloud PBX | 565 | 38 | +1387% |
| MS Teams Voice (UK) | 523 | 457 | +14% |
| CCaaS (UK) | 48 | 40 | +20% |
...
|------------|--------|--------|
| Cisco Collaboration Suite (Full UK Launch) | Q4 2025 | October launch |
...
| Fusion IoT eSIM (UK/DE) | H2 2025 | In progress |
| Starface AI features | H2 2025 | In progress |
| Spain partner (40K seats commitment) | 5 years | Signed |

### Cost Efficiency (UK)

| Initiative | Impact | Timeline |
|------------|--------|----------|
| UK restructuring | £6-8M annual savings | H2 2025 |
...
| UK Cloud Seats | 1,063K | 1,100K | - |
| Germany Cloud Seats | 565K | 600K | - |
| MS Teams Voice | 540K | 650K | - |
| CCaaS Seats | 53K | 60K | - |
| Active Partners (UK) | 1,500 | 1,600 | - |
...
2. **AI Differentiation**
   - AI Receptionist launch in Q4
   - Starface AI features
   - Competitive advantage vs 8x8, RingCentral

3. **Partner Retention**
   - Edge Channel Proposition rollout
   - O2 Daisy managed service model replication
   - Clear Business partnership model expansion

### Medium-Term (2026)

1. **Germany Scale**
   - Target 750K+ cloud seats
...
3. **Pan-European**
   - Placetel model extension (adjacent markets)
   - Operator Connect International growth
